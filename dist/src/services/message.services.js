...
const CreateMessage = (requestDto) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        index_1.io.to(`chat_${chatId}`).emit('newMessage', { chatId: chatId, senderId: senderId, receiverId: receiverId, content: content, createdAt: createdMsg.createdAt, id: createdMsg.id });
        return createdMsg;
    }
    catch (e) {
        throw e;
