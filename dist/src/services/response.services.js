...
exports.DeleteResponse = exports.UpdateResponse = exports.CreateResponse = exports.GetOneResponseById = exports.GetAllResponse = void 0;
 ...
 * @param responseId
 */
const GetOneResponseById = (responseId) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.GetOneResponseById = GetOneResponseById;
...
const DeleteResponse = (responseId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield prisma.response.delete({
            where: {
                id: responseId
            }
        });
